...
public final class DataBrowser extends MonitoredPanel {
    ...
    public static void createPanel(String path) {
        java.awt.EventQueue.invokeLater(() -> {
            ...
            frame.setTitle("FDA Data Browser");
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(scrollFolder, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 354, Short.MAX_VALUE)
        );
