 ...
 *
 * Created on Dec 21, 2010, 12:47:38 PM
 */
...
public class CollapsibleContainer extends javax.swing.JPanel {
     ...
     * @param icon          Name of the icon to dislay for the group. The icon files are located in ch.psi.fda.ui.ce.icons.
     *                      The name of the icon is just the icon file name withou the .png suffix.
     *                      For example "photo" will load the photo.png in the ch.psi.fda.ui.ce.icons package.
     * @param component     Panel that should be collapsible
     */
    public CollapsibleContainer(String header, String icon, Component component) {
        ...
        ProcessorFDA.setIcon(jLabel2, getClass().getResource("/ch/psi/fda/ui/ce/icons/wrench.png"));        
        ProcessorFDA.setIcon(jButton1, getClass().getResource("/ch/psi/fda/ui/ce/icons/sq_up.png"));        
        ProcessorFDA.setIcon(jButton2, getClass().getResource("/ch/psi/fda/ui/ce/icons/plus.png"));        
        if ((icon!=null) &&!icon.isEmpty()){
            ProcessorFDA.setIcon(jLabel2, getClass().getResource("/ch/psi/fda/ui/ce/icons/"+icon+".png"));        
        }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ch/psi/fda/ui/ce/icons/sq_up.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ch/psi/fda/ui/ce/icons/wrench.png"))); // NOI18N
    ...
    private void collapse() {
        if(collapsed){
            ...
            ProcessorFDA.setIcon(jButton1, getClass().getResource("/ch/psi/fda/ui/ce/icons/sq_down.png"));        
