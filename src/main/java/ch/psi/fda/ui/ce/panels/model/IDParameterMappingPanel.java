 ...
 * @author ebner
 */
public class IDParameterMappingPanel extends javax.swing.JPanel implements ObjectProvider<IDParameterMapping>, EditableComponent {

    private boolean modified = false;
    private IDParameterMapping mapping;
    ...
    public IDParameterMappingPanel(final IDParameterMapping mapping) {
        ...
        jComboBoxType.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent ie) {
                modified = true;
                mapping.setRefid(ModelUtil.getInstance().getObject((String)jComboBoxType.getSelectedItem()));
            }
        });
    ...
    @Override
    public IDParameterMapping getObject() {
        return mapping;
    }
