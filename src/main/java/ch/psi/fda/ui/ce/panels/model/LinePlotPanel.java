 ...
 * @author ebner
 */
public class LinePlotPanel extends javax.swing.JPanel implements ObjectProvider<LinePlot>, EditableComponent {
...
//                plot.setY(ModelUtil.getInstance().getObject((String)jComboBoxY.getSelectedItem()));
    ...
    private void jComboBoxXPopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_jComboBoxXPopupMenuWillBecomeVisible
        Logger.getLogger(LinePlotPanel.class.getName()).log(Level.INFO, "X Popup becomes visible");
        // Get selected item
